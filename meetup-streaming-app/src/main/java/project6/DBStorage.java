...
public class DBStorage {
    	...
    	if (json.has("venue")==true)
    	{
	        ...
	        try {
	        	...
	        	sb = sb.append("UPDATE test_meetup.cities SET ")
	        			...
	        			.append(", lat = ").append(city.getFloat("lat"))
	        			.append(", lon = ").append(city.getFloat("lon"))
	        			.append(", city = $$").append(city.getString("city")).append("$$ ")
	        			.append(", members = ").append(city.getInt("member_count"))
	        			.append(" WHERE cityid = ").append(city.getInt("id")).append(";");
    ...
    public void insertIntoCities(JSONObject json)
    {
    	...
    	sb= sb.append("UPDATE test_meetup.cities SET ")
    			.append(" cityid = ").append(json.getInt("id"))
    			...
    			.append(" WHERE cityid = ").append("id").append(";");
